    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{route('sys-module.update', $entity->id)}}">
                    {!! csrf_field() !!}
                    {!! method_field('PUT') !!}
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="number" class="form-control" id="sort" placeholder="排序" name="sort" value="{{$entity->sort}}">
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
